...
<br>
<h1 class="title">历史工资查询——按部门查询</h1>
<br>
<div class="box-content" id="insert">
    <form action="controller/history2Servlet.do" method="post">
        <div class="br">
            <label>请输入部门名称：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" class="form-control" name="dpname" placeholder="请输入部门名称">
        </div>
    <!--    请输入部门名称：<input type="text" class="form-control" name="dpname" placeholder="请输入部门名称"> -->
...
<form action="controller/history2Servlet.do" method="post">
    <table>
        <tr>
            <td>请输入部门名称:</td><td><input type="text" class="form-control" name="dpname" placeholder="请输入部门名称"></td>
        </tr>
    </table>
    <input type="submit" class="btn btn-default" value="提交">
</form> -->
